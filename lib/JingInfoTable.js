    ...
    render(){
        ...
        if(mode === "h" || mode === "horizontal"){
            ...
            for(var index in infos){
                ...
                if(index == 0 && title){
                    tds.push(<td key={index} style={titleStyle} rowSpan={rowsize} width={titleWidth}>{title}</td>);
                }
                tds.push(<td key={index} style={labelStyle}>{item.label}</td>);
                let link = item.link;
                let width = item.width || 300;
                if(link){
                    if(typeof link == "function"){
                        tds.push(<td key={index} style={contentStyle} width={width}><a href="javascript:void(0);" onClick={item.link} rel={item.value}>{item.value}</a></td>);
                    }else{
                        tds.push(<td key={index} style={contentStyle} width={width}><a href={link} target="_blank">{item.value}</a></td>);
                    }
                }else{
                    ...
                    tds.push(<td key={index} style={contentStyle} width={width}>{keyValue}</td>);
                }
            ...
            for(var index in labels){
                ...
                if(index == 0){
                    tds.push(<td key={index} style={titleStyle} rowSpan={values.length + 1} width={titleWidth}>{title}</td>);
                }
                tds.push(<td key={index} style={infoLabelStyle} width={width}>{item.label}</td>);
            }
            trs.push(<tr>{tds}</tr>);
            tds = [];
